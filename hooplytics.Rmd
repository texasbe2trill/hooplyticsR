...
players <- c("Klay Thompson", "Dillon Brooks", "Ja Morant")
...
player_projections <- list(
  "Klay Thompson" = list(
    points_model = 16.5,
    fantasy_score_model = 27.5,
    total_pra_model = 23.5,
    threepm_model = 2.5,
    assists_model = 3.5
  ...
  "Dillon Brooks" = list(
    points_model = 9.5,
    fantasy_score_model = 22.5,
    total_pra_model = 19.5,
    threepm_model = 1.5,
    assists_model = 1.5
  ),
  "Ja Morant" = list(
...
player_5_game_averages <- list(
  ...
  "Dillon Brooks" = list(
    points_model = 18,
    fantasy_score_model = 26.0,
    total_pra_model = 23.6,
    threepm_model = 3,
    assists_model = 2.2
  ),
  "Ja Morant" = list(
    points_model = 28.8,
    fantasy_score_model = 45.3,
    total_pra_model = 39.8,
    threepm_model = 2.2,
    assists_model = 7.8
